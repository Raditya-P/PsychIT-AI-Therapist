...
PSYCHIT_BNBCONFIG = BitsAndBytesConfig(
    load_in_4bit = True,
...
LORA_NAME = "radityap/QLoRA-PsychIT"

def load_model_and_token():
    tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME)
    model = MistralForCausalLM.from_pretrained(MODEL_NAME, quantization_config=PSYCHIT_BNBCONFIG, device_map="auto", low_cpu_mem_usage=True)
